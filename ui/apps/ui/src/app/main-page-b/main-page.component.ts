...
export class MainPageBComponent {
  userActivities$: Observable<IUserActivityResponse[]> =
    this._userActivityService.get();
  latestInformations$: Observable<ILatestInfo[]> =
    this._latestInfoService.get();
  recommendedResources$: Observable<IRecommendedResource[]> =
    this._recommendedResourcesService.get();
  recommendedPublications$: Observable<IRecommendedPublication[]> =
    this._recommendedPublicationsService.get();
  popularArticles$: Observable<IPopularArticle[]> =
    this._popularArticlesService.get();
